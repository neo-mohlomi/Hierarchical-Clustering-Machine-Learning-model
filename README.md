...
In this project , similar to the previous K-means Clustering project , I explored mall customer data using unsupervised machine learning technique: Hierarchical Clustering. The purpose of the project is to identify distinct customer segments and generate actionable business insights.
